...
const routes: Record<string, RouteItem[]> = {
  ...
  "👻 Órfãs — Cliente (legado)": [
    { path: "/__orphan/agenda", label: "Agenda", status: "orphan" },
    { path: "/__orphan/agendamento-sucesso", label: "Agendamento Sucesso", status: "orphan" },
    { path: "/__orphan/avisos", label: "Avisos", status: "orphan" },
    { path: "/__orphan/configuracoes", label: "Configurações (legado)", status: "orphan" },
    { path: "/__orphan/historico", label: "Histórico", status: "orphan" },
    { path: "/__orphan/home", label: "Home", status: "orphan" },
    { path: "/__orphan/index", label: "Index", status: "orphan" },
    { path: "/__orphan/minha-garagem", label: "Minha Garagem (legado)", status: "orphan" },
    { path: "/__orphan/novo-agendamento", label: "Novo Agendamento", status: "orphan" },
    { path: "/__orphan/os-acompanhamento", label: "OS Acompanhamento", status: "orphan" },
    { path: "/__orphan/os-orcamento", label: "OS Orçamento", status: "orphan" },
    { path: "/__orphan/performance", label: "Performance", status: "orphan" },
    { path: "/__orphan/profile", label: "Perfil", status: "orphan" },
    { path: "/__orphan/register", label: "Registro", status: "orphan" },
    { path: "/__orphan/veiculos", label: "Veículos", status: "orphan" },
    { path: "/__orphan/visao-geral", label: "Visão Geral", status: "orphan" },
    { path: "/__orphan/login-old", label: "Login (antigo)", status: "orphan" },
    { path: "/__orphan/login-cliente", label: "Login Cliente", status: "orphan" },
    { path: "/__orphan/os-ultimate-client", label: "OS Ultimate Client", status: "orphan" },
  ],
  "👻 Órfãs — Admin (legado)": [
    { path: "/__orphan/admin-clientes", label: "Admin Clientes (legado)", status: "orphan" },
    { path: "/__orphan/admin-dashboard-old", label: "Admin Dashboard (antigo)", status: "orphan" },
    { path: "/__orphan/admin-dashboard-ias", label: "Dashboard IAs", status: "orphan" },
    { path: "/__orphan/admin-dashboard-orcamentos", label: "Dashboard Orçamentos", status: "orphan" },
    { path: "/__orphan/admin-dashboard-overview", label: "Dashboard Overview", status: "orphan" },
    { path: "/__orphan/admin-login", label: "Admin Login (legado)", status: "orphan" },
    { path: "/__orphan/admin-melhorias", label: "Admin Melhorias", status: "orphan" },
    { path: "/__orphan/admin-monitoramento-kommo", label: "Monitoramento Kommo", status: "orphan" },
    { path: "/__orphan/admin-operacional", label: "Admin Operacional", status: "orphan" },
    { path: "/__orphan/admin-painel-tv", label: "Painel TV", status: "orphan" },
    { path: "/__orphan/admin-parametros", label: "Admin Parâmetros", status: "orphan" },
    { path: "/__orphan/admin-veiculos", label: "Admin Veículos", status: "orphan" },
    { path: "/__orphan/cadastros", label: "Hub Cadastros", status: "orphan" },
    { path: "/__orphan/clientes-legacy", label: "Clientes (legacy)", status: "orphan" },
    { path: "/__orphan/importar-dados", label: "Importar Dados", status: "orphan" },
    { path: "/__orphan/monitoramento-patio", label: "Monitoramento Pátio", status: "orphan" },
    { path: "/__orphan/nova-os-legacy", label: "Nova OS (legacy)", status: "orphan" },
    { path: "/__orphan/ordens-servico-legacy", label: "Ordens Serviço (legacy)", status: "orphan" },
    { path: "/__orphan/pendencias-legacy", label: "Pendências (legacy)", status: "orphan" },
    { path: "/__orphan/dashboard-cockpit", label: "Dashboard Cockpit", status: "orphan" },
    { path: "/__orphan/component-showcase", label: "Component Showcase", status: "orphan" },
  ],
  "👻 Órfãs — Gestão": [
    { path: "/__orphan/kommo-v2", label: "Kommo V2", status: "orphan" },
  ],
};
