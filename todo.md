...
- [ ] Criar calculadora para identificar oportunidades de venda
- [ ] Análise de histórico do cliente (serviços anteriores)
- [ ] Sugestões de serviços preventivos baseado em km/tempo
- [ ] Cálculo de potencial de faturamento por cliente
- [ ] Dashboard com clientes de maior potencial
- [ ] Alertas de oportunidade (troca de óleo, revisão, etc.)

## Visão Outros Pátios
- [ ] Criar visualização multi-pátio para gestão
- [ ] Dashboard consolidado de todas as unidades
- [ ] Filtro por empresa_id
- [ ] Comparativo de performance entre pátios
- [ ] Transferência de veículos entre unidades
- [ ] Métricas agregadas (total veículos, faturamento, etc.)
